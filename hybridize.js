...
Object.entries(Components).forEach(([componentName, Component]) => {
  if (!Component.defaultHybridProps)
    return console.error(
      `Exported React components must include static object 'defaultHybridProps' property`
    )
  ...
  Object.entries(Component.defaultHybridProps).forEach(
    ([name, defaultValue]) => {
